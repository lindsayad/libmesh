...
// we do nothing.
template <typename RealType> void FEShim<2,MONOMIAL,RealType>::compute_constraints (DofConstraints &, DofMap &, const unsigned int, const Elem *) {}
template <typename RealType> void FEShim<3,MONOMIAL,RealType>::compute_constraints (DofConstraints &, DofMap &, const unsigned int, const Elem *) {}
