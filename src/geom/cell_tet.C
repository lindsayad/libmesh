...
void Tet::choose_diagonal() const
{
  ...
  if (this->_diagonal_selection==INVALID_DIAG)
    {
      GeomReal diag_01_23 = (this->point(0) + this->point(1) - this->point(2) - this->point(3)).norm_sq();
      GeomReal diag_02_13 = (this->point(0) - this->point(1) + this->point(2) - this->point(3)).norm_sq();
      GeomReal diag_03_12 = (this->point(0) - this->point(1) - this->point(2) + this->point(3)).norm_sq();
