...
#ifndef LIBMESH_DEFAULT_COUPLING_IMPL_H
#define LIBMESH_DEFAULT_COUPLING_IMPL_H
...
void DefaultCouplingTempl<RealType>::set_dof_coupling(const CouplingMatrix * dof_coupling)
{
...
template <typename RealType>
void DefaultCouplingTempl<RealType>::mesh_reinit()
{
...
template <typename RealType>
void DefaultCouplingTempl<RealType>::operator()
...
#endif // LIBMESH_DEFAULT_COUPLING_IMPL_H
