...
FE<Dim,T,RealType>::FE (const FEType & fet) :
    FEGenericBase<typename FEOutputType<T>::type,RealType> (Dim,fet),
...
template <unsigned int Dim, FEFamily T, typename RealType>
unsigned int FE<Dim,T,RealType>::n_shape_functions () const
{
  return FE<Dim,T,RealType>::n_dofs (this->elem_type,
                                     static_cast<Order>(this->fe_type.order + this->_p_level));
}


template <unsigned int Dim, FEFamily T, typename RealType>
void FE<Dim,T,RealType>::attach_quadrature_rule (QBase * q)
{
  libmesh_assert(q);
  this->qrule = q;
...
template <unsigned int Dim, FEFamily T, typename RealType>
unsigned int FE<Dim,T,RealType>::n_quadrature_points () const
{
...
template <unsigned int Dim, FEFamily T, typename RealType>
void FEDofsOnSideShim<Dim,T,RealType>::dofs_on_side(const Elem * const elem,
                                                    const Order o,
                                                    unsigned int s,
                                                    std::vector<unsigned int> & di)
{
  ...
  {
    const unsigned int n_dofs = FE<Dim,T,RealType>::n_dofs_at_node(elem->type(),
...
template <unsigned int Dim, FEFamily T, typename RealType>
void FEDofsOnSideShim<Dim,T,RealType>::dofs_on_edge(const Elem * const elem,
                                                    const Order o,
                                                    unsigned int e,
                                                    std::vector<unsigned int> & di)
{
...
template <unsigned int Dim, FEFamily T, typename RealType>
void FE<Dim,T,RealType>::reinit(const Elem * elem,
...
template <unsigned int Dim, FEFamily T, typename RealType>
void FE<Dim,T,RealType>::init_shape_functions(const std::vector<Point> & qp,
                                              const Elem * elem)
{
...
template <unsigned int Dim, FEFamily T, typename RealType>
void FE<Dim,T,RealType>::init_base_shape_functions(const std::vector<Point> & qp,
                                                   const Elem * e)
{
...
template  <unsigned int Dim, FEFamily T, typename RealType>
PointTempl<RealType> FEInverseMapShim<Dim, T, RealType>::inverse_map (const Elem * elem,
                                                                      const Point & p,
...
template  <unsigned int Dim, FEFamily T, typename RealType>
void FEInverseMapShim<Dim, T, RealType>::inverse_map (const Elem * elem,
