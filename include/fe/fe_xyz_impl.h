...
// we do nothing.
template <typename RealType> void FEShim<2,XYZ,RealType>::compute_constraints (DofConstraints &, DofMap &, const unsigned int, const Elem *) {}
template <typename RealType> void FEShim<3,XYZ,RealType>::compute_constraints (DofConstraints &, DofMap &, const unsigned int, const Elem *) {}
