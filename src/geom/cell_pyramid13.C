                                        ...
                                        unsigned int side_node) const
{
  ...
  libmesh_assert_less(side_node, Pyramid13::nodes_per_side);
...
GeomReal Pyramid13::volume () const
{
  ...
  static const int dx_deta_exponents[14][3] =
    {
      {0, 0, 0},
      {0, 0, 1},
      {0, 0, 2},
  ...
  static const int dx_dzeta_exponents[19][3] =
    {
      {0, 0, 0},
      {0, 0, 1},
      {0, 0, 2},
