 ...
 * physical domain for H1 conforming elements. This class assumes the
 * \p FEGenericBase object has been initialized in the reference
...
public:
   ...
   * conforming elements. dphi/dx = dphi/dxi * dxi/dx, etc.
   */
   ...
   * on H1 conforming finite element transformation.
   */
  ...
  /**
   * Evaluates the shape function curl in physical coordinates based
   * on H1 conforming finite element transformation.
   */
   ...
   * based on H1 conforming finite element transformation.
   */
